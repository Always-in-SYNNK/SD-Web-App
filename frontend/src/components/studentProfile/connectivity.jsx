  ...
  return (
    <section className="bg-white p-8 lg:p-12 rounded-xl shadow-sm">
      ...
      <fieldset className="space-y-2">
        <legend className="text-xs font-semibold uppercase tracking-wider text-gray-400">Email Address</legend>
        <label className="relative block">
          <i className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400" aria-hidden="true">✉️</i>
          <input
            type="email"
