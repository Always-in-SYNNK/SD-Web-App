  ...
  return (
    <section className="px-8 pt-20 pb-32 max-w-screen-xl mx-auto grid lg:grid-cols-12 gap-12 items-center">
      <article className="lg:col-span-7 space-y-8">
        <mark className="inline-flex px-4 py-2 rounded-full bg-green-100 text-green-800 text-xs font-bold uppercase tracking-widest">
          The Resilient Architect
        </mark>
        <h1 className="text-5xl md:text-6xl font-extrabold leading-tight">
          Designing the future of{" "}
          <em className="text-[#035b9d] italic">South African</em> potential.
        </h1>
