export function OpportunityCard() {
  return (
    <div className="bg-white p-8 rounded-xl shadow-sm flex space-x-6">
      ...
      <div>
        <span className="px-2 py-0.5 bg-amber-100 text-amber-700 text-[10px] font-bold rounded uppercase mb-2 inline-block">
          Matched Opportunity
        </span>
