  ...
  return (
    <section className="bg-[#035b9d] text-white p-8 rounded-xl flex flex-col md:flex-row items-center justify-between gap-6 mb-8">
      ...
      <label className="cursor-pointer w-full md:w-auto">
        ...
        <div className="px-8 py-6 border-2 border-dashed border-blue-300 rounded-xl flex flex-col items-center justify-center space-y-2 hover:bg-blue-800 transition min-w-[240px]">
          <span className="text-3xl">📤</span>
          <span className="font-bold text-sm">Drop PDF or Click to Upload</span>
        </div>
      </label>
    </section>
  );
